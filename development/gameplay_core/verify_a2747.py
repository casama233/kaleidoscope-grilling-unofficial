...
BLOCKS={
 'pepper_log.json':'a2747_pepper_log.block.json',
 'pepper_leaves.json':'a2747_pepper_leaves.block.json',
 'pepper_sapling.json':'a2747_pepper_sapling.block.json',
}
LOOT={
 'pepper_log.json':'a2747_pepper_log.loot.json',
 'pepper_sapling.json':'a2747_pepper_sapling.loot.json',
 'pepper_leaves_fallback.json':'a2747_pepper_leaves_fallback.loot.json',
}
...
def main():
 ...
 assert bm['header']['name']=='Kaleidoscope Grilling A2.7.47 Pepper Tree Lifecycle BP'
 ...
 assert (BP/'recipes/oak_planks_from_pepper_log.json').read_bytes()==(DEV/'a2747_oak_planks_from_pepper_log.recipe.json').read_bytes()
 ...
 assert main_text.count("import './a2747_pepper_tree_runtime.js';")==1
 core=(BP/'scripts/a2747_pepper_tree_core.js').read_text(encoding='utf-8')
 for token in ('pepperTreePlan','pepperLeafBreakPlan','saplingBonemealSucceeds','pepperLogAxis','STING_INTERVAL_TICKS=20'):
  assert token in core,token
 runtime=(BP/'scripts/a2747_pepper_tree_runtime.js').read_text(encoding='utf-8')
 ...
 report=load(P/'reports/a2747-pepper-tree-lifecycle.json')
 assert report['version']=='A2.7.47'
 ...
 result={
  'version':'A2.7.47','pepper_tree_lifecycle':True,'sapling_growth':True,'leaf_fruiting':True,
