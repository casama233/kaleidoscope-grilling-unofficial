...
const core=new vm.SourceTextModule(fs.readFileSync(new URL('a2711_mantou_chopping_core.js',root),'utf8'),{context,identifier:'core'});
const rt=new vm.SourceTextModule(fs.readFileSync(new URL('a2711_mantou_chopping_runtime.js',root),'utf8'),{context,identifier:'runtime'});
...
console.log(JSON.stringify({passed:7,failed:0,scope:'A2.7.11 Cookery mantou chopping registration'}));
