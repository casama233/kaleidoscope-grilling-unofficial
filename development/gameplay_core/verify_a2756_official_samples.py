...
def main():
 for name,(path,expected,tokens) in FILES.items():
  req=urllib.request.Request(BASE+path,headers={'User-Agent':'Grilling-A2.7.56-official-samples/1'})
 ...
 print('A2.7.56 pinned Microsoft minecraft-scripting-samples contract: PASS')
 print('commit:',COMMIT)
