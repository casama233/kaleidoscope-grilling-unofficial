...
def main():
 ...
 assert bm['header']['version']==[2,7,11] and rm['header']['version']==[2,7,11]
 assert bm['header']['name']=='Kaleidoscope Grilling A2.7.11 Mantou Chopping BP'
 assert rm['header']['name']=='Kaleidoscope Grilling A2.7.11 Mantou Chopping RP'
 ...
 core=(BP/'scripts/a2711_mantou_chopping_core.js').read_text(encoding='utf-8')
 for token in (
 ...
 runtime=(BP/'scripts/a2711_mantou_chopping_runtime.js').read_text(encoding='utf-8')
 ...
 report=load(P/'reports/a2711-parity.json')
 assert report['version']=='A2.7.11'
 ...
 result={
  'version':'A2.7.11','raw_mantou_slice_item':True,'mantou_chopping_registered':True,
  'cuts':4,'output_count':3,'bun_slice_chain_reachable':True,
  'exact_java_staged_board_visual':False,
  'a2710_chicken_acquisition_preserved':True,
  'a279_beef_override_preserved':True,'a278_basic_chopping_preserved':True,
  'compiled':a.compiled,'compiled_packs':compiled,
  'minecraft_tested':False,'bds_tested':False
 }
 out=P/'reports'/('a2711-dash-verification.json' if a.compiled else 'a2711-structure-verification.json')
