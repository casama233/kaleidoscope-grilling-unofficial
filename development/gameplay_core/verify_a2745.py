...
def main():
 ...
 assert (BP/'blocks/advanced_rack_block.json').read_bytes()==(DEV/'a2745_advanced_rack_block.json').read_bytes()
 assert (BP/'items/advanced_rack.json').read_bytes()==(DEV/'a2745_advanced_rack_item.json').read_bytes()
 assert (BP/'recipes/advanced_rack.json').read_bytes()==(DEV/'a2745_advanced_rack_recipe.json').read_bytes()
 ...
 assert load(RP/'textures/terrain_texture.json')['texture_data']['kg_a2745_advanced_rack']['textures']=='textures/blocks/advanced_rack'
 ...
 assert main_text.count("import './a2745_advanced_rack_runtime.js';")==1
 runtime=(BP/'scripts/a2745_advanced_rack_runtime.js').read_text(encoding='utf-8')
 ...
 codec=(BP/'scripts/a2745_rack_item_codec.js').read_text(encoding='utf-8')
 ...
 api=(BP/'scripts/a2745_rack_automation_api.js').read_text(encoding='utf-8')
 ...
 report=load(P/'reports/a2745-advanced-rack.json')
 ...
 result={'version':'A2.7.45','advanced_rack':True,'compartments':9,'persistent_filters':True,'deposit_matching':True,
