...
def main():
 ...
 report=load(P/'reports/a2728-localization.json')
 ...
 out=P/'reports'/('a2728-dash-verification.json' if a.compiled else 'a2728-structure-verification.json')
 out.write_text(json.dumps({'version':'A2.7.28','languages':['zh_CN','zh_TW','en_US'],'keys':96,'compiled':a.compiled,'compiled_packs':compiled,'minecraft_tested':False},ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
