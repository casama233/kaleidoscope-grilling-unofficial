...
import {KC_READY_EVENT,KC_REGISTER_EVENT,registrationsForReady} from './a2710_mantou_chopping_core.js';
...
// system.run callback fires, so adding A2.7.10 does not create duplicate pings.
