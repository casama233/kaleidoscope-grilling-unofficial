...
def fetch(key):
 path,sha=FILES[key]
 req=urllib.request.Request(BASE+path,headers={'User-Agent':'Grilling-A2.7.49-contract/1'})
...
def main():
 ...
 print('A2.7.49 pinned Java Sugared Tomato + Pepper Honey contract: PASS')
