...
def main():
 ...
 assert bm['header']['name']=='Kaleidoscope Grilling A2.7.46 Wedding Candy BP'
 ...
 wedding=(BP/'scripts/a2746_wedding_candy_runtime.js').read_text(encoding='utf-8')
 ...
 assert main_text.count("import './a2746_wedding_candy_runtime.js';")==1
 ...
 report=load(P/'reports/a2746-wedding-candy.json')
 assert report['version']=='A2.7.46' and report['java_contract']['nutrition']==20
 ...
 result={
  'version':'A2.7.46','wedding_candy':True,'shared_standalone_food_effect_runtime':True,
