...
def main():
 if len(sys.argv)!=2:raise SystemExit('usage: verify_a2711_cookery_contract.py <Cookery 1.0.6 mcaddon>')
 ...
 assert not re.search(r'"kaleidoscope_cookery:mantou"\s*:',d), 'Cookery now has a built-in mantou station recipe; extension parity must be re-audited'
 print('A2.7.11 Cookery 1.0.6 mantou extension contract: PASS')
